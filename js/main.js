...
function winModal() {
      ...
      modalContent.innerHTML = `<p class="modalHeading">Congratualations! You Won!</p><p class="p1">with ${noOfMoves} moves and ${noOfStars} stars</p><p class="p2"><button onclick="winModal();" class="modal-close-button" id="close-button">Restart</button></p>`;
...
function startTimer() {
    ...
    let minTime = startDate.getMinutes();
    starRating();
